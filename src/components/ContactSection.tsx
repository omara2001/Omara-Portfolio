        ...
        <div className="grid lg:grid-cols-2 gap-10 max-w-5xl mx-auto">
          <div>
            ...
            <div className="flex gap-3">
              ...
              <a href="https://huggingface.co/madayasser6" target="_blank" rel="noopener noreferrer">
                <Button variant="outline" size="icon" className="rounded-full">
              ...
              <a href="https://profile.indeed.com/" target="_blank" rel="noopener noreferrer">
                <Button variant="outline" size="icon" className="rounded-full">
                  <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="https://www.facebook.com/mohamed.yasser.944023" target="_blank" rel="noopener noreferrer">
                <Button variant="outline" size="icon" className="rounded-full">
                  <Facebook className="h-5 w-5" />
                  <span className="sr-only">Facebook</span>
                </Button>
              </a>
              <a href="https://www.instagram.com/mohamed_omara_21?igsh=a3c0NjY4MW0xMzRo&utm_source=qr" target="_blank" rel="noopener noreferrer">
                <Button variant="outline" size="icon" className="rounded-full">
                  <Instagram className="h-5 w-5" />
                  <span className="sr-only">Instagram</span>
                </Button>
              </a>
              <a href="https://x.com/moomara21?s=21&t=16R6tbmdNigYD3aioa-aoA" target="_blank" rel="noopener noreferrer">
                <Button variant="outline" size="icon" className="rounded-full">
                  <Twitter className="h-5 w-5" />
                  <span className="sr-only">X</span>
                </Button>
              </a>
              <a href="https://wa.me/201061816662" target="_blank" rel="noopener noreferrer">
                <Button variant="outline" size="icon" className="rounded-full">
                  <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="https://t.me/Mohamed_omara21" target="_blank" rel="noopener noreferrer">
                <Button variant="outline" size="icon" className="rounded-full">
                  <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
